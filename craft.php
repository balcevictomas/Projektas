<?php include 'header.php'; ?>
      ...
      <div class="row">
        <div class="col s12 m6 l4">
          <div class="card hoverable">
            <div class="card-image">
              <img src="images/beer-contents.gif">
            </div>
        ...
        <div class="col s12 m6 l4">
          <div class="card hoverable">
            <div class="card-image">
              <img src="images/beer-milling.gif">
            </div>
            <div class="card-content">
        ...
        <div class="col s12 m6 l4">
          <div class="card hoverable">
            <div class="card-image">
              <img src="images/beer-mashing.gif">
            </div>
            <div class="card-content">
        ...
        <div class="col s12 m6 l4">
          <div class="card hoverable">
            <div class="card-image">
              <img src="images/beer-boiling.gif">
            </div>
            <div class="card-content">
        ...
        <div class="col s12 m6 l4">
          <div class="card hoverable">
            <div class="card-image">
              <img src="images/beer-chilling.gif">
            </div>
            <div class="card-content">
        ...
        <div class="col s12 m6 l4">
          <div class="card hoverable">
            <div class="card-image">
              <img src="images/beer-fermenting.gif">
            </div>
            <div class="card-content">
