      ...
      <div class="col s10 m6 l4 container" >
	      <div class="valign-wrapper" >
			  <div class="card-panel hoverable " style="width: 100%;"  >   
			  		<form action="php_files/log.php" method="POST">
					        ...
					        <div class="input-field">
					          ...
					          <label for="icon_telephone">Your pass</label>
					        </div>
					        <button class="btn waves-effect waves-light red " style = "width: 100%;" type="submit" name="action">Log in
